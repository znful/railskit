...
ActiveRecord::Schema[8.1].define(version: 2025_11_09_162215) do
  ...
  create_table "inivitations", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "account_id", null: false
    t.datetime "created_at", null: false
    t.text "message"
    t.string "receiver"
    ...
    t.string "token"
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_inivitations_on_account_id"
    t.index ["sender_id"], name: "index_inivitations_on_sender_id"
  end
  ...
  add_foreign_key "inivitations", "accounts"
  add_foreign_key "inivitations", "users", column: "sender_id"
